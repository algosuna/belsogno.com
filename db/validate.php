...
if($_POST['did_send']=='true'){
	...
	if(strlen($name)==0 OR strlen($message)==0){
		$valid=false;
		$blank_error="<div class='error'>You cannot leave this blank.</div>";
	}
	...
	if($valid==true){
		...
		if($mail_sent==1){
			$success="<div class='success'>Thank you for your feedback I, the webMaster, give my word to contact you back on your inquiry shorlty.</div>";
		}else{
			$db_error="<div class='error'>Sorry, something went wrong, mail was not sent.</div>";
		}
	}
}